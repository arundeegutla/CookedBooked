...
class TaskAnnotationView: MKAnnotationView {
    ...
    enum Constants {
        ...
        static var pointerViewHeight: CGFloat { containerViewHeight / 3 }

        // The distance the pointer view extends downwards after rotation. Half of the hypotenuse of the view.
        static var pointerViewHeightAfterRotation: CGFloat { pointerViewHeight * sqrt(2) / 2 }
    }
    ...
    // Internal function to do initial view setup
    private func setupView() {
        
        // Container View: The main view for our annotation view
        let containerView = UIView()
        
        // Set this property to false for any programatic view that uses programmatic auto layout constraints.
        ...
        NSLayoutConstraint.activate([
            pointerView.heightAnchor.constraint(equalToConstant: Constants.pointerViewHeight),
            pointerView.widthAnchor.constraint(equalToConstant: Constants.pointerViewHeight),
        ...
        // Transform rotation uses radians so we'll convert 45 degrees to radians. `radians = degrees * pi / 180`
        ...
        // The image should fill the entire view while maintaining it's original aspect (i.e. no stretch/distortion).
        ...
        centerOffset = CGPoint(x: -(Constants.containerViewHeight / 2), y: -Constants.containerViewHeight - Constants.pointerViewHeightAfterRotation)
